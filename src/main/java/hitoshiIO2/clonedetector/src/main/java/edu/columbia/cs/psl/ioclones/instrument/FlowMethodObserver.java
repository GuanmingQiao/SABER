...
public class FlowMethodObserver extends MethodVisitor implements Opcodes {
	...
	public void visitCode() {
		...
		System.out.println("Parameter info: " + paramInfos);
	...
	public void visitVarInsn(int opcode, int var) {
		...
		if (this.recordInput != null) {
			...
			//this.convertToInst(var);
			System.out.println("In FlowMethodObserver, visiting VAR instruction. Registering input!");
			this.mv.visitMethodInsn(INVOKEVIRTUAL, 
					Type.getInternalName(IORecord.class), 
					"registerInput", 
		...
		if (this.recordInput != null) {
			...
			switch(opcode) {
				...
				case IFLE:
					...
					this.mv.visitInsn(SWAP);
					this.mv.visitInsn(ICONST_0);
					System.out.println("In FlowMethodObserver, visiting jump IFEQ-IFLE instruction. Registering input!");
					this.mv.visitMethodInsn(INVOKEVIRTUAL, 
							Type.getInternalName(IORecord.class), 
							"registerInput", 
							"(Ljava/lang/Object;Z)V", 
				...
				case IFNONNULL:
					...
					this.mv.visitInsn(SWAP);
					this.mv.visitInsn(ICONST_1);
					System.out.println("In FlowMethodObserver, visiting jump IFNULL/IFNONNULL instruction. Registering input!");
					this.mv.visitMethodInsn(INVOKEVIRTUAL, 
							Type.getInternalName(IORecord.class), 
							"registerInput", 
							"(Ljava/lang/Object;Z)V", 
				...
				case IF_ICMPLE:
					...
					if (copySignal == 2) {
						for (int i = 0; i < 2; i++) {
							...
							this.mv.visitInsn(SWAP);
							this.mv.visitInsn(ICONST_0);
							System.out.println("In FlowMethodObserver, visiting jump IF_ICMPEQ-IF_ICMPLE instruction, copy signal 2. Registering input!");
							this.mv.visitMethodInsn(INVOKEVIRTUAL, 
									Type.getInternalName(IORecord.class), 
									"registerInput", 
									"(Ljava/lang/Object;Z)V", 
						...
						this.mv.visitInsn(SWAP);
						this.mv.visitInsn(ICONST_0);
						System.out.println("In FlowMethodObserver, visiting jump IF_ICMPEQ-IF_ICMPLE instruction, copy signal 0. Registering input!");
						this.mv.visitMethodInsn(INVOKEVIRTUAL, 
								Type.getInternalName(IORecord.class), 
								"registerInput", 
								"(Ljava/lang/Object;Z)V", 
						...
						this.mv.visitInsn(SWAP);
						this.mv.visitInsn(ICONST_0);
						System.out.println("In FlowMethodObserver, visiting jump IF_ICMPEQ-IF_ICMPLE instruction, copy signal 1. Registering input!");
						this.mv.visitMethodInsn(INVOKEVIRTUAL, 
								Type.getInternalName(IORecord.class), 
								"registerInput", 
								"(Ljava/lang/Object;Z)V", 
	...
	public void visitLookupSwitchInsn(Label dflt, int[] keys, Label[] labels) {
		...
		if (this.recordInput != null) {
			...
			this.mv.visitInsn(SWAP);
			this.mv.visitInsn(ICONST_0);
			System.out.println("In FlowMethodObserver, visiting lookup switch instruction. Registering input!");
			this.mv.visitMethodInsn(INVOKEVIRTUAL, 
					Type.getInternalName(IORecord.class), 
					"registerInput", 
					"(Ljava/lang/Object;Z)V", 
	...
	public void visitTableSwitchInsn(int min, int max, Label dflt, Label... labels) {
		...
		if (this.recordInput != null) {
			...
			this.mv.visitInsn(SWAP);
			this.mv.visitInsn(ICONST_0);
			System.out.println("In FlowMethodObserver, visiting table switch instruction. Registering input!");
			this.mv.visitMethodInsn(INVOKEVIRTUAL, 
					Type.getInternalName(IORecord.class), 
					"registerInput", 
					"(Ljava/lang/Object;Z)V", 
	...
	public void visitIincInsn(int var, int increment) {
		if (this.recordInput != null) {
			...
			this.convertToInst(var);
			this.mv.visitInsn(ICONST_0);
			System.out.println("In FlowMethodObserver, visiting Iinc instruction. Registering input!");
			this.mv.visitMethodInsn(INVOKEVIRTUAL, 
					Type.getInternalName(IORecord.class), 
					"registerInput", 
					"(Ljava/lang/Object;IZ)V", 
