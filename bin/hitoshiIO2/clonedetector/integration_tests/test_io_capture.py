...
HITOSHIIO_PREANALYZER_COMMAND = ('java -cp target/CloneDetector-0.0.1-SNAPSHOT.jar edu.columbia.cs.psl.ioclones.analysis.PreAnalyzer -cb integration_tests/d_multtester')
HITOSHIIO_INSTRUMENTATION_COMMAND = ('java -javaagent:target/CloneDetector-0.0.1-SNAPSHOT.jar -noverify -cp "target/CloneDetector-0.0.1-SNAPSHOT.jar" edu.columbia.cs.psl.ioclones.driver.IODriver -class hitoshiio_test.MultTester -cb integration_tests/d_multtester')
